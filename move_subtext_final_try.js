...
const newSubtextHTML = '<div style="flex-grow: 1; display: flex; justify-content: flex-end; padding-right: 5vw;">' +
...
// Find Row 2 (the flex container holding "Systems")
let row2 = $('h1:contains("Systems")').last().closest('.showcase_marquee_flex');
...
if (row2.length > 0) {
    ...
    console.log('Could not find Systems row.');
}
