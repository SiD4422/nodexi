...
<section class="reveal" style="background: var(--black); padding: 100px 60px; overflow: hidden; position: relative;">
  ...
  <div style="max-width: var(--max); margin: 0 auto; position: relative; z-index: 1;">
    ...
    <div style="display: flex; align-items: center; gap: 16px; margin-top: 48px; padding-top: 40px; border-top: 1px solid rgba(255,255,255,0.1);">
      <div style="width: 48px; height: 48px; background: linear-gradient(135deg, var(--purple), #a78bfa); border-radius: 50%; display: flex; align-items: center; justify-content: center; font-size: 20px; font-weight: 900; color: #fff;">A</div>
      <div>
        <div style="font-size: 16px; font-weight: 800; color: #fff;">Aryan Sharma</div>
...
<section class="reveal" style="max-width: var(--max); margin: 0 auto; padding: 100px 60px 60px;">
  ...
  <div style="display: grid; grid-template-columns: 1.4fr 1fr 1fr; gap: 24px;">
    ...
    <!-- FOUNDER — TALL LEFT CARD -->
    <div style="background: var(--black); border-radius: 32px; padding: 48px; display: flex; flex-direction: column; justify-content: flex-end; min-height: 480px; position: relative; overflow: hidden; row-span: 2;">
      ...
      <div style="position: relative; z-index: 2;">
        <div style="width: 72px; height: 72px; background: rgba(255,255,255,0.15); backdrop-filter: blur(10px); border: 2px solid rgba(255,255,255,0.3); border-radius: 50%; display: flex; align-items: center; justify-content: center; font-size: 30px; font-weight: 900; color: #fff; margin-bottom: 24px;">A</div>
        <div style="font-size: 28px; font-weight: 900; color: #fff; margin-bottom: 8px; letter-spacing: -0.02em;">Aryan Sharma</div>
        ...
        <p style="font-size: 15px; color: rgba(255,255,255,0.75); line-height: 1.7;">Full-stack engineer and systems architect. Deep background in distributed systems, AI pipelines, and embedded hardware. Previously built infrastructure for 2M+ user platforms.</p>
        <div style="display: flex; gap: 8px; margin-top: 24px; flex-wrap: wrap;">
          ${['Go','Rust','React','K8s','AWS'].map(t => `<span style="background: rgba(255,255,255,0.1); color: rgba(255,255,255,0.85); font-size: 11px; font-weight: 700; padding: 4px 12px; border-radius: 999px; border: 1px solid rgba(255,255,255,0.15);">${t}</span>`).join('')}
        </div>
      </div>
    </div>
    
    <!-- CO-FOUNDER: TOP RIGHT -->
    <div style="background: var(--gray-50); border: 1px solid var(--gray-200); border-radius: 32px; padding: 40px; display: flex; flex-direction: column; justify-content: flex-end; min-height: 220px; position: relative; overflow: hidden; transition: all 0.3s;" onmouseover="this.style.borderColor='var(--purple)'; this.style.transform='translateY(-4px)'" onmouseout="this.style.borderColor='var(--gray-200)'; this.style.transform=''">
      <div style="position: absolute; top: 24px; right: 24px; width: 56px; height: 56px; background: linear-gradient(135deg, #0ea5e9, #38bdf8); border-radius: 50%; display: flex; align-items: center; justify-content: center; font-size: 22px; font-weight: 900; color: #fff;">R</div>
      <div style="font-size: 22px; font-weight: 900; color: var(--black); margin-bottom: 6px;">Rahul Mehta</div>
      <div style="font-size: 12px; font-weight: 700; color: var(--purple); text-transform: uppercase; letter-spacing: 1.5px; margin-bottom: 16px;">Co-Founder & Design Lead</div>
      <p style="font-size: 14px; color: var(--gray-500); line-height: 1.6;">Shipped UI for 20+ SaaS products. Obsessed with motion design and the details nobody else notices.</p>
    </div>

    <!-- CLOUD LEAD: TOP RIGHT 2 -->
    <div style="background: var(--gray-50); border: 1px solid var(--gray-200); border-radius: 32px; padding: 40px; display: flex; flex-direction: column; justify-content: flex-end; min-height: 220px; position: relative; overflow: hidden; transition: all 0.3s;" onmouseover="this.style.borderColor='var(--purple)'; this.style.transform='translateY(-4px)'" onmouseout="this.style.borderColor='var(--gray-200)'; this.style.transform=''">
      <div style="position: absolute; top: 24px; right: 24px; width: 56px; height: 56px; background: linear-gradient(135deg, #059669, #34d399); border-radius: 50%; display: flex; align-items: center; justify-content: center; font-size: 22px; font-weight: 900; color: #fff;">S</div>
      <div style="font-size: 22px; font-weight: 900; color: var(--black); margin-bottom: 6px;">Sahil Verma</div>
      <div style="font-size: 12px; font-weight: 700; color: var(--purple); text-transform: uppercase; letter-spacing: 1.5px; margin-bottom: 16px;">Cloud & DevOps Lead</div>
      <p style="font-size: 14px; color: var(--gray-500); line-height: 1.6;">AWS certified architect & Kubernetes specialist. Obsessed with reliability, cost efficiency, and zero-downtime deploys.</p>
    </div>
